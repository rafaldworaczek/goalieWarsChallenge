...
namespace AudioManagerMultiNS
{
    ...
    public class AudioManager : MonoBehaviour
    {
        ...
        private BallMovementMultiplayer ballScript;
        private PowersMulti powersScript;
        ...
        private void Start()
        {
                ...
                SceneManager.GetActiveScene().name.Equals("gameSceneMultiplayer_Room_2"))
            {
                ...
                ballScript = GameObject.Find("ball1").GetComponent<BallMovementMultiplayer>();
        ...
        public void Commentator_RunToBallFast()
        {
            ...
            if (
                (isMaster && (ballScript.getBallPos().z > 0f)) ||
                (!isMaster && (ballScript.getBallPos().z < 0f)) ||
        ...
        public void Commentator_NormalGameComment()
        {
            ...
            if ((isMaster && (ballScript.getBallPos().z < 0f)) ||
                (!isMaster && (ballScript.getBallPos().z > 0f)) ||
                !playerMainScript.doesGameStarted())
                return;
        ...
        public string Commentator_getRandGoalAudio(bool isCpu)
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                if (isCpu)
                    isVolleyGoal = playerMainScript.peerPlayer.getShotType();

                bool isLobGoal = playerMainScript.isLobShotActive();
                if (isCpu)
                    isLobGoal = playerMainScript.peerPlayer.isLobShotActive();
        ...
        {
            //cpu goal
            if (!powersScript.isGoalUpEnlarge() &&
            ...
            //player goal
            if (!powersScript.isGoalDownEnlarge() &&
        ...
        private void Commentator_LongRangeShot()
        {
            ...
            if (cpuShotActive)
            {
                Vector3 getCpuPos = playerMainScript.peerPlayer.getPlayerPosition();
        ...
        public void Commentator_rocketShot()
        {
            ...
            if ((playerMainScript.peerPlayer.getShotActive() &&
                (playerMainScript.peerPlayer.getTimeOfBallFly() < (ShotSpeedMin + 50f)) &&
                (playerMainScript.peerPlayer.getCurveShotFlyPercent() > 0.7f) &&
                playerMainScript.peerPlayer.isShotCurve()) ||
        ...
        public void Commentator_onBallLongTime()
        {
            ...
            if ((ballScript.getBallPos().z >= 0) &&
                playerMainScript.peerPlayer.getLastTimePlayerOnBall() != -1f)
                runTime = Time.time - playerMainScript.peerPlayer.getLastTimePlayerOnBall();
        ...
        public void Commentator_maxTimeToShot()
        {
            ...
            if ((randChangeEverySecond == 0) &&
                ...
                (playerMainScript.getIsPlayerOnTheBallNow() ||
                                   playerMainScript.peerPlayer.getIsPlayerOnTheBallNow()))
            {
        ...
        private void Commentator_missShot_playerUP()
        {
            ...
            {
                Vector3 endPos = playerMainScript.peerPlayer.getEndPosOrg();
