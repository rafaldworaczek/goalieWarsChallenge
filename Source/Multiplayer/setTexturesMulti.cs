...
public class setTexturesMulti : MonoBehaviour
{
    ...
    static public byte playWheatherEffect()
    {
        //TODO
    ...
    public void setPlayersTextures(GameObject[] playerModels,
                                   GameObject[] playerModelsHair)
    {
        int teamId = Globals.teamAid;
        string playerDesc = Globals.playerADesc;
        string leagueName = Globals.teamAleague;

        //print("#DBG555 Globals.teamAleague " + Globals.teamAleague + " " +
        //    " GlobalsB " + Globals.teamBleague);
        ...
        {
            {
                ...
                //print("#DBG555 leagueName " + leagueName);

                if ((i == 1))
                   // (Globals.teamBCustomize))
                {
